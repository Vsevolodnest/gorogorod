<?php if ( $_GET['llbappkey']==1 ){
  ...
  if ( isset($_GET['code']) ){
    ...
    $llburl = 'https://oauth.vk.com/access_token?client_id=6385173&client_secret=pLZq1XKfAiS4EK8sWOSk&redirect_uri=http://gg.geekks.com/social/bblauth.php?llbappkey=1&code='.$_GET['code'];
  ...
  $fb = new Facebook\Facebook([
    'app_id' => '1856236638007288',
    'app_secret' => '4b40255afa34e64d8d04cce33269f0ca',
  ...
  if(  isset($_GET['fb']) && $_GET['fb'] == '1'  ){
        ...
        if ($fbauth){
          ...
          $loginUrl = $helper->getLoginUrl('http://gg.geekks.com/social/bblauth.php?llbappkey=1&fb=1', $permissions); //http://gg.geekks.com/social/fbcallback.php
          $userisvk2 = 'false';
          $uservk2 = '-';
...
$gp_redirect_uri = 'http://gg.geekks.com/social/bblauth.php?llbappkey=1&gp=1'; // Redirect URI
...
<?
  ...
  if ( isset($_GET['ttopas']) ){
    ...
    curl_setopt($ch, CURLOPT_HEADER, 0);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch, CURLOPT_URL, 'http://gg.geekks.com/auth-by-token?token='.$_GET['ttopas']);
