...
if ( $_GET['llbappkey']==1 ){ 
    ...
    header('Content-Type: text/html; charset=utf-8');
        ...
        if ( isset($_GET['code']) ){
            ...
            $llburl = 'https://oauth.vk.com/access_token?client_id=6385170&client_secret=BXqJldIpueMGXjx8fATr&redirect_uri=http://s.geekks.com/social/posttovk.php?llbappkey=1%26repostparams='.$_GET['repostparams'].'&code='.$_GET['code'];
...
//            print_r( $forpostparams );exit;
        ...
        //'http://s.geekks.com/get-coupons-list?token_key=551f645cc030f7bb70bc380e9fd93217'
